export default async function handler(req, res) {
    ...
    try {
        ...
        if (type === 'analyze') {
            ...
            const prompt = `أنت محلل جيوسياسي من أمثال هنري كيسنجر وبريجنسكي. مهمتك تحليل الأخبار بدقة شديدة وواقعية كاملة.

قواعد صارمة:
- اذكر أسماء دول وأشخاص وتنظيمات حقيقية من الخبر مباشرة
- لا تستخدم كلمات عامة مثل "المنطقة" أو "الدول المعنية" أو "المنظمات الدولية"
- الموقع الجغرافي يجب أن يكون المكان الحقيقي المذكور في الخبر (مدينة أو دولة محددة)
- مستوى التهديد يجب أن يعكس خطورة الحدث الفعلي بدقة
- السيناريوهات يجب أن تكون مبنية على معطيات الخبر الحقيقية

أجب بـ JSON نقي فقط بدون أي نص خارجه:
{
  "threat_level": "حرج أو مرتفع أو متوسط أو منخفض",
  "threat_score": رقم_من_0_إلى_100,
  "summary": "3 جمل تحليلية دقيقة تذكر الأسماء والأماكن الحقيقية",
  "parties": ["اسم_دولة_أو_شخص_حقيقي_1", "اسم_دولة_أو_شخص_حقيقي_2"],
  "interests": "المصالح الحقيقية لكل طرف بالتفصيل في جملتين",
  "scenarios": {
    "current": "وصف الوضع الراهن بأرقام وأسماء حقيقية",
    "best": "أفضل سيناريو بناءً على معطيات الخبر",
    "worst": "أسوأ سيناريو بناءً على معطيات الخبر"
  },
  "forecast": "توقعات محددة خلال 30 يوماً مع ذكر احتمالات واقعية",
  "lat": إحداثية_خط_العرض,
  "lng": إحداثية_خط_الطول,
  "location_name": "اسم_المدينة_أو_الدولة_الحقيقية"
}

الخبر للتحليل: "${decodedText}"`;
